...
arduino/CDC.o: /home/victor/arduino/arduino-1.0.5/hardware/arduino/cores/arduino/CDC.cpp
	...
	avr-g++ -I/home/victor/arduino/arduino-1.0.5/hardware/arduino/cores/arduino -I/home/victor/arduino/arduino-1.0.5/hardware/arduino/variants/standard -DUSB_PID= -DUSB_VID= -DARDUINO=105 -Wall -Os -fno-exceptions -g  -ffunction-sections  -fdata-sections -mmcu=atmega328p -DF_CPU=16000000UL -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)"  -c -o "$@" "$<"
